...
test("signup presents the approved acquisition surface without promising public access", async () => {
  ...
  assert.match(html, /sign-in policy/i);
  ...
  assert.doesNotMatch(html, /free trial|billing|open signup|any Google account/i);
});
