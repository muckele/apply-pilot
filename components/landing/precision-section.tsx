...
const pillars = [
  { icon: FileCheck2, title: "Evidence-backed", copy: "Apply Pilot uses the information you provide to prepare application material. Review every proposal for accuracy before use.", label: "PROVIDED SOURCE", detail: "Resume.pdf · Added 2 days ago" },
      ...
      <div className="public-container">
        <div className="precision-grid">
          ...
          <div className="precision-panel">
            ...
            <p className="precision-caption"><ShieldCheck aria-hidden="true" /> From your source-linked information to your submitted application—every step is intentional.</p>
          </div>
        </div>
