      ...
      <div className="public-container">
        <div className="showcase-grid">
          <div className="showcase-intro">
            <h2 id="showcase-title">Automation,<br />built from<br />what you provide.</h2>
            <p>
              Apply Pilot helps organize the search, evaluate fit, and prepare application material
              from the experience and qualifications you provide—with review before use and without
              taking over the final decision.
            </p>
            <ul>
              ...
              <li><FileText aria-hidden="true" /> Review qualifications before use</li>
            </ul>
          </div>
          <div className="showcase-panels" aria-label="Illustrative product surfaces">
            <article className="showcase-panel fit-panel">
              ...
              <h4>Top evidence</h4>
              {evidenceItems.map((item) => <p key={item}><Check aria-hidden="true" /><span>{item}<small>Source-linked experience</small></span></p>)}
            ...
            <article className="showcase-panel plan-panel">
              ...
              <div className="plan-table">
                <div><strong>Job requirement</strong><strong>Source-linked experience</strong><strong>Gap (honest)</strong></div>
        ...
        <div className="evidence-lineage" aria-label="From provided source to proposed answer">
          <h3>From source to proposed answer</h3>
          <div>
            <article><FileText aria-hidden="true" /><span><strong>1&nbsp; Provided source</strong><b>Operations process redesign</b><small>Case study · Lines 45–87</small><em>Review before use</em></span></article>
            <i aria-hidden="true" />
