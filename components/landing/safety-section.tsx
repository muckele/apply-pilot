    ...
    <section className="public-section safety-section" id="safety" aria-labelledby="safety-title">
      <div className="public-container safety-grid">
        ...
        <figure className="submission-boundary">
          ...
          <div className="boundary-assist">This release helps you discover roles, evaluate fit, and prepare materials for your review.</div>
          <ol>
          ...
          <div className="boundary-user-copy">Apply Pilot does not fill or submit the employer form in this release. Review your materials, enter any required information, and personally submit on the employer website.</div>
          <div className="boundary-status"><span><UserRound aria-hidden="true" /> Preparation authority · <em>Current</em></span><span><UserRound aria-hidden="true" /> Employer submission · User only</span></div>
          <figcaption className="sr-only">Apply Pilot assists through review, then leaves employer-form entry and submission to the applicant.</figcaption>
        </figure>
      </div>
    </section>
  );
