...
const safetyItems = [
  [FileText, "Source-informed proposals"],
    ...
    <section className="public-section safety-section" id="safety" aria-labelledby="safety-title">
      <div className="public-container safety-grid">
        ...
        <figure className="submission-boundary">
          ...
          <div className="boundary-assist">Apply Pilot can inspect, propose, and fill approved supported fields only when you choose.</div>
          <ol>
          ...
          <div className="boundary-user-copy">Apply Pilot has not submitted this application. Review the employer form, complete any manual fields, and personally submit on the employer website.</div>
